...
<html class="no-js" lang="">
    <head>
        <meta charset="utf-8">
        <title>Profile Picture | Create</title>
                        ...
                        <nav class="navbar navbar-inverse">
                            <div class="container-fluid">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="../Profilepic/index.php">Profile Picture</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <nav class="navbar navbar-inverse">
                            <div class="container-fluid">
                                <div class="navbar-header">
                                    <a class="navbar-brand" href="index.php">Profile Pic</a>
                                </div>
                                <ul class="nav navbar-nav">
                    ...
                    <div class="col-lg-12">
                        <form action="store.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="user_name" id="name" class="form-control" placeholder="User Name">
                            </div>
