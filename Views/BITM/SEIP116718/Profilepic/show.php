                    ...
                    <div class="col-lg-12">
                        <table class="table table-hover" boder = 1>
                            <thead>
                             ...
                             <tbody>
                                <tr>
                                    <td><?php echo $AllPicture['id']?></td>
                                    <td><?php echo $AllPicture['user_name']?></td>
                                    <td><img src="<?php echo "../../../../img/".$AllPicture['image'] ?>" width="200" height="180" class="img-circle"></td>
                                    <td>
                                        <a href="edit.php?id=<?php echo $AllPicture['id']?>"><i class="fa fa-pencil-square-o fontedit"></i></a> |
                                        <a href="softdelete.php?id=<?php echo $AllPicture['id']; ?>"><i class="fa fa-trash fontedit"></i></a> 
                                    </td>
                                </tr>
                            </tbody>
                            </thead>
