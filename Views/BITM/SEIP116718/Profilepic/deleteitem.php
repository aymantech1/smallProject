                        ...
                        <table class="table table-inverse table_index">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="restore.php?id=<?php echo $OnePicture['id'] ?>"><i class="fa fa-retweet"></i></a>  |
                                        <a href="delete.php?id=<?php echo $OnePicture['id'] ?>"><i class="fa fa-trash fontedit"></i></a> 
                                    </td>
                                </tr>
                                <?php
                                }
