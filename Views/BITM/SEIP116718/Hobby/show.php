                        ...
                        <table class="table table-hover" boder = 1>
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $takeOneData['create_at']?></td>
                                    <td>
                                        <a href="edit.php?id=<?php echo $takeOneData['id']?>"><i class="fa fa-pencil-square-o fontedit"></i></a> |
                                        <a href="softdelete.php?id=<?php echo $takeOneData['id']; ?>"><i class="fa fa-trash fontedit"></i></a> 
                                    </td>
                                </tr>
                        </table>
                    </div>
